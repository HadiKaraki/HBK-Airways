...
<body>
    ...
    <div class="container">
        <h1>Sign Up</h1>
        <br>
        <h5>Already have an account? <a href="SignIn.php" style="text-decoration:none;color:blue">Login</a></h5>
        <br>
        <form method="post" action="Form.php" class="check-validation" novalidate>
            <div class="row">
                <div class="col-sm-4 p-2">
                    <label for="Fname"> First Name</label>
                    <input type="text" autocomplete="off" class="form-control" name="Fname" placeholder="First name"
                        required>
                    <div class="invalid-feedback">Please Enter a Valid First Name.</div>
                </div>
                <div class="col-sm-4 p-2">
                    <label for="Mname"> Middle Name</label>
                    <input type="text" autocomplete="off" class="form-control" name="Mname" placeholder="Middle name"
                        required>
                    <div class="invalid-feedback">Please Enter a Valid Middle Name.</div>
                </div>
                <div class="col-sm-4 p-2">
                    <label for="Lname"> Last Name</label>
                    <input type="text" autocomplete="off" class="form-control" name="Lname" placeholder="Last name"
                        required>
            ...
            <div class="row">
                <div class="col-sm-6 p-2">
                    ...
                    <input type="email" autocomplete="off" class="form-control" name="mail"
                ...
                <div class="col-sm-6 p-2">
                    ...
                    <input type="tel" autocomplete="off" class="form-control" name="phone" placeholder="###-###-####"
                        pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required>
                    <div class="invalid-feedback">Please Enter Your A Valid Phone Number.</div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <input type="text" autocomplete="off" class="form-control" id="card_number" name="card_number"
                        placeholder="1111-1111-1111-1111" pattern="[0-9]{4}-[0-9]{4}-[0-9]{4}-[0-9]{4}" required>
                ...
                <div class="col-sm-4">
                    ...
                    <input type="txt" class="form-control" id="exp_date" name="exp_date" placeholder="02/22"
            ...
            <div class="row">
                <div class="col-sm-6 p-2">
                    ...
                    <input type="text" autocomplete="off" class="form-control" id="username" name="username"
                        placeholder="Ex: Adams123" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,15}" required>
                    <div class="required_username">
                        <ul>
                            <small>Usename must have the following: </small>
                            <li class="loweruser"><span> A lowercase letter</span> </li>
                            <li class="upperuser"><span> A uppercase letter</span> </li>
                            <li class="numuser"><span> A number</span> </li>
                            <li class="minuser"><span> Minimum of 8 characters but no more than 20</span> </li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6 p-2">
                    <label for="pssword">Password</label>
                    <input type="password" class="form-control" id="pssword" name="pssword"
                        pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,20}" required>
                    <div class="required_password">
                        <ul>
                            <small>Password must have the following: </small>
                            <li class="lowerpass"><span> A lowercase letter</span> </li>
                            <li class="upperpass"><span> A uppercase letter</span> </li>
                            <li class="numpass"><span> A number</span> </li>
                            <li class="minpass"><span> Minimum of 8 characters but no more than 20</span> </li>
